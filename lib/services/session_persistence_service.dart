...
class SessionPersistenceService {
  ...
  Future<SavedSession?> load() async {
    try {
      ...
      final expenses = (data['expenses'] as List).map((e) => _expenseFromJson(e as Map<String, dynamic>)).toList();
...
class SavedSession {
  ...
  SavedSession({required this.fileName, required this.savedAt, required this.expenses});
